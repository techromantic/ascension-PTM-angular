...
export var DB_NAME = 'ascension-db';
export var DB_VERSION = 1;

@Injectable()
export class COSMAngularIndexedDBService {
  private utils: Utils;
  private dbWrapper: DbWrapper;

  constructor() {
    this.utils = new Utils();
    this.dbWrapper = new DbWrapper(DB_NAME, DB_VERSION);
    this.createStore(DB_VERSION, (evt) => {
      let objectStore = evt.currentTarget.result.createObjectStore('docStore', { keyPath: "_id"});
